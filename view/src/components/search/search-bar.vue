<template>
  <div class="container">
    ...
    <div v-if="focus" class="toggle" @click="onClick" :style="{backgroundColor: content_flag ? 'var(--blue)' : 'white'}">
        <svg v-if="content_flag" class="check-mark-svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="6.83594 -74.6582 78.85746 78.80859"> <!-- top-left-corner-x top-left-corner-y width height -->
            <g>
